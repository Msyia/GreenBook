...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/profil_page.css') }}">
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar bg-light border-end ">
            <div class="d-flex flex-column ">
                ...
                <hr style="margin-left:0px;">
                <button class="btn text-dark fw-bold" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="
    ...
    line-height: 24px; letter-spacing: 0.5px; text-align: left; padding: 0; margin-left: 17px;">
        ...
        <div class="container-fluid p-4">
            <div class="card mx-auto shadow-sm" style="max-width: 600px;">
                <a href="{{'beranda-after-login'}}" style=""><button class="back-button">
                        <span class="arrow">←</span> Profil
                    </button></a>
                <div class="card-body text-center">
                    <!-- Profile Picture -->
                    <div class="profile-pic mx-auto mb-3">
                        <img src="{{ asset('images/beranda.png')}}" class="rounded-circle" alt="Profile Picture">
                    </div>
    ...
    <script src="{{ asset('js/profil_page.js') }}"></script>
</body>
